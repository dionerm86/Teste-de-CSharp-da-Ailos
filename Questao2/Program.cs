...
namespace Questao2
{
    public class Program : HttpService
    {
        ...
        private static async Task<List<Partidas>> GetMatchesForTypeTeam(string team, int year, string teamType)
        {
            List<Partidas> matches = new();
        ...
        private static int GetGoalsForTypeTeam(Partidas match, string team)
        {
            int goals = 0;
